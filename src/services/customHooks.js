...
export function customHooksHandleAnterior(page,tituloGuardado,setDatos,setPage){
    if(page.pageMax>2){
...
export function customHooksHandleBuscar(busqueda,setDatos,setTituloGuardado,setPage,setNumRes,setBusqueda){
    fetch(
